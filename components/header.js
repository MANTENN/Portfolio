...
export const Header = () => {
  ...
  return (
    <header className="sticky top-4 bg-white bg-opacity-70 backdrop-filter backdrop-blur-md dark:bg-gray-800 shadow-xs border border-solid border-gray-600 dark:border-gray-100 border-opacity-10 dark:border-opacity-10 rounded-2xl container padded-container mx-auto z-10">
